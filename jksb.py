...
def sign_in(id, pwd):
    ...
    form = {
        ...
        "myvs_13c": "河南省.郑州市，管城区", # 自己填写当前所在地即可
        "myvs_24": "否",
        "myvs_26": "5",  # 疫苗接种情况：0是待选；1是1针剂；2是2针剂；3是尚未接种；4是有禁忌症，无法接种；5是三针3针剂
        #"myvs_14b": "",  # 该选项已弃用
        "memo22": "河南省郑州市管城回族区霍寨北街21号", # [待定] 位置获取情况
        ...
        "fun3": "",
        #"jingdu": "113.690339", #经度：自己校区经度 此处默认北校区经度,jingdu=113.658055
        #"weidu": "34.747296",   #纬度：自己校区纬度 此处默认北校区纬度,&weidu=34.782807  东经113.658333北纬34.7822222
        "ptopid": ptopid,
        "sid": sid,
    }
    headers = {
